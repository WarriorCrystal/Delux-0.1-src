...
public class RenderUtil
{
    ...
    public static void blockEsp(final BlockPos blockPos, final Color c, final double length, final double length2) {
        final double x = blockPos.getX() - RenderUtil.mc.getRenderManager().renderPosX;
        final double y = blockPos.getY() - RenderUtil.mc.getRenderManager().renderPosY;
        final double z = blockPos.getZ() - RenderUtil.mc.getRenderManager().renderPosZ;
        GL11.glPushMatrix();
