...
public class WurstplusRenderUtil
{
    ...
    public static void GlPost() {
        GLPost(WurstplusRenderUtil.depth, WurstplusRenderUtil.texture, WurstplusRenderUtil.clean, WurstplusRenderUtil.bind, WurstplusRenderUtil.override);
    }
    ...
    public static void GLPrePhobos(final float lineWidth) {
        WurstplusRenderUtil.depth = GL11.glIsEnabled(2896);
        WurstplusRenderUtil.texture = GL11.glIsEnabled(3042);
        WurstplusRenderUtil.clean = GL11.glIsEnabled(3553);
        WurstplusRenderUtil.bind = GL11.glIsEnabled(2929);
        WurstplusRenderUtil.override = GL11.glIsEnabled(2848);
        GLPre(WurstplusRenderUtil.depth, WurstplusRenderUtil.texture, WurstplusRenderUtil.clean, WurstplusRenderUtil.bind, WurstplusRenderUtil.override, lineWidth);
    }
    
    public static void drawBox(final BlockPos blockPos, final int color) {
        drawBox(WurstplusRenderUtil.mc.world.getBlockState(blockPos).getSelectedBoundingBox((World)WurstplusRenderUtil.mc.world, blockPos), color);
    }
    ...
    public static void drawSphere(final double x, final double y, final double z, final float size, final int slices, final int stacks) {
        ...
        GL11.glTranslated(x - WurstplusRenderUtil.mc.getRenderManager().renderPosX, y - WurstplusRenderUtil.mc.getRenderManager().renderPosY, z - WurstplusRenderUtil.mc.getRenderManager().renderPosZ);
