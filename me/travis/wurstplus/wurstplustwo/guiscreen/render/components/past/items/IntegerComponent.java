...
public class IntegerComponent extends Component
{
    ...
    public IntegerComponent(final WurstplusSetting value, final ModuleButton button, final int offset) {
        this.dragging = false;
        this.set = value;
        this.parent = button;
    ...
    public void renderComponent() {
        ...
        Gui.drawRect(this.parent.parent.getX() + 1, this.parent.parent.getY() + this.offset, this.parent.parent.getX() + this.parent.parent.getWidth() - 1, this.parent.parent.getY() + this.offset + 15, -13684945);
