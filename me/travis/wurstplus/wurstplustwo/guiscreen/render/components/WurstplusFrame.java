...
public class WurstplusFrame
{
    ...
    public WurstplusFrame(final WurstplusCategory category) {
        ...
        this.move_x = 0;
        this.move_y = 0;
        final int size = Wurstplus.get_hack_manager().get_modules_with_category(category).size();
        int count = 0;
        for (final WurstplusHack modules : Wurstplus.get_hack_manager().get_modules_with_category(category)) {
    ...
    public void refresh_frame(final WurstplusModuleButton button, final int combo_height) {
        this.height = 25;
        final int size = Wurstplus.get_hack_manager().get_modules_with_category(this.category).size();
        int count = 0;
    ...
    public void render(final int mx, final int my) {
        ...
        final int nc_r = Wurstplus.click_gui.theme_frame_name_r;
        final int nc_g = Wurstplus.click_gui.theme_frame_name_g;
        final int nc_b = Wurstplus.click_gui.theme_frame_name_b;
        final int nc_a = Wurstplus.click_gui.theme_frame_name_a;
        final int bg_r = Wurstplus.click_gui.theme_frame_background_r;
        final int bg_g = Wurstplus.click_gui.theme_frame_background_g;
        final int bg_b = Wurstplus.click_gui.theme_frame_background_b;
        final int bg_a = Wurstplus.click_gui.theme_frame_background_a;
        final int bd_r = Wurstplus.click_gui.theme_frame_border_r;
        final int bd_g = Wurstplus.click_gui.theme_frame_border_g;
        final int bd_b = Wurstplus.click_gui.theme_frame_border_b;
