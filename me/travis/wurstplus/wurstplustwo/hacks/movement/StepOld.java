...
public class StepOld extends WurstplusHack
{
    ...
    public WurstplusSetting vanilla;
    public WurstplusSetting stepHeightVanilla;
    public WurstplusSetting stepHeight;
    public WurstplusSetting spoof;
    public WurstplusSetting ticks;
    public WurstplusSetting turnOff;
    public WurstplusSetting check;
    public WurstplusSetting small;
